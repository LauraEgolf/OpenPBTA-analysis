...
Note: CNV breaks data is missing 20 samples (excluded during consensus CNV generation), which are not missing from SV breaks or chromothripsis data (used CNVkit-only for this version)
